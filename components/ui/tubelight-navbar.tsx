...
export function NavBar({ items, className }: NavBarProps) {
    ...
    return (
        ...
        >
            <div className="flex items-center gap-3 bg-white/50 dark:bg-black/50 border border-zinc-200 dark:border-white/10 backdrop-blur-lg py-1 px-1 rounded-full shadow-lg">
                {items.map((item) => {
                    ...
                    return (
                        <Link
                            ...
                            className={cn(
                                ...
                                isActive && "bg-zinc-100 dark:bg-white/10 text-black dark:text-white",
                            )}
                        >
